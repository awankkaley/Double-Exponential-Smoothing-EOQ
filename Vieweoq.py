...
class Plot:
    ...
    def __init__(self, master, data):
        ...
        self.tombol_proses = Button(self.master, text="Proses", command=lambda: self.proses(data), bg='green',
                                    width='10')
    ...
    def proses(self, data):
        ...
        if self.adaFile["text"] == "File belum ada":
            ...
            def eoq_awal():
                EOQAWAL = math.sqrt((2 * dataku * S) / (harga[0] * self.gudang_id))
                hasil = [round(EOQAWAL)]
